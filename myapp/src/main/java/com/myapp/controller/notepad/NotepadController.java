package com.myapp.controller.notepad;
...
import org.ecrp.framework.ui.util.NodeUtils;
...
public class NotepadController extends NotepadView {
    ...
    final static Logger logger = LoggerFactory.getLogger("NotepadController");
    ...
    private Tab createTab() {
        ...
        try {
            Node content = FXMLLoader.load(NotepadController.class
                    .getResource("/com/myapp/fxmlView/notepad-tab.fxml")
            );
