...
import com.myapp.controller.index.IndexController;
...
import org.ecrp.framework.utils.ECSystemUtil;
import org.ecrp.framework.utils.StageUtils;
...
public class Main extends Application {
    ...
    public static void main(String[] args) {
        ...
        // 初始化本地语言
        RESOURCE_BUNDLE = ECSystemUtil.initSystemLocal("locale.Menu");
...
//        stage.show();
    ...
    private void loadNewUI(Stage primaryStage) throws IOException {
        ...
        fxmlLoader.setLocation(Main.class.getResource("/org/ecrp/framework/fxmlView/newui/main.fxml"));
