...
import org.ecrp.framework.ui.helper.LayoutHelper;
...
public class JavaFxViewUtil {
    ...
    final static Logger logger = LoggerFactory.getLogger("JavaFxViewUtil");
...
//		newStage.setMaximized(false);
    ...
    public static void setControllerOnCloseRequest(Object controller, Event event) {
        try {
            ...
            logger.error("执行onCloseRequest方法失败", e);
        }
    }
        ...
        if (min instanceof Integer) {
            ...
            spinner.getEditor().textProperty().addListener((observable, oldValue, newValue) -> {
                try {
                    ...
                    logger.warn("数字int转换异常 newValue:" + newValue);
            ...
            spinner.getEditor().textProperty().addListener((observable, oldValue, newValue) -> {
                try {
                    ...
                    logger.warn("数字double转换异常 newValue:" + newValue);
                    spinner.getEditor().setText(oldValue);
                }
            });
        }
