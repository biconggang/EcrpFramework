package org.ecrp.framework.ui.control;
...
public class IntegerSpinner extends Spinner<Integer> {
    ...
    public void setValue(int value) {
        SpinnerValueFactory.IntegerSpinnerValueFactory valueFactory = getSpinnerValueFactory();
    ...
    public SpinnerValueFactory.IntegerSpinnerValueFactory getSpinnerValueFactory() {
        return (SpinnerValueFactory.IntegerSpinnerValueFactory) getValueFactory();
    }
