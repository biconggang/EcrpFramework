package org.ecrp.framework.utils;
...
public class ECSystemUtil {
     ...
     * @Description: 初始化本地语言
     */
    public static ResourceBundle initSystemLocal(String baseName) {
        ...
        try {
            ...
            res = ResourceBundle.getBundle(baseName, Config.defaultLocale);
        } catch (Exception e) {
