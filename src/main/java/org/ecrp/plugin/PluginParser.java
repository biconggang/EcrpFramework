package org.ecrp.plugin;

import org.ecrp.common.AppException;
...
public class PluginParser {
    ...
    final static Logger logger = LoggerFactory.getLogger("PluginParser");
    ...
    public static void parse(File pluginFile, PluginJarInfo pluginJarInfo, ClassLoader classLoader) {
        ...
        if (!pluginFile.exists()) {
            logger.error("插件 {} 文件不存在: {}", pluginJarInfo.getName(), pluginFile.getAbsolutePath());
            return;
        }
